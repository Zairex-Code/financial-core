...
- **Diagramas:** en `docs/diagrams/drawio/` está el **diseño de la solución**, el **despliegue Docker** y los **diagramas de secuencia por microservicio** (archivos `.drawio` para abrir directo en draw.io). La especificación detallada está en `docs/diagrams/00-especificacion-diagramas.md` y un prompt reutilizable en `docs/diagrams/01-prompt-ia-diagramas.md`.
...
├── docs/diagrams/             ← diagramas draw.io (diseño, despliegue y secuencias)
